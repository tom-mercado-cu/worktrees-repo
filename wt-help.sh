...
echo ""
echo -e "  ${YELLOW}wt-new${NC} ${DIM}[repo] <branch> [-c] [-b]${NC}"
...
echo -e "      ${DIM}-b, --base-branch: Choose custom base branch interactively${NC}"
echo ""
...
echo ""
echo -e "  ${YELLOW}wt-multi-new${NC} ${DIM}[directory] [-c] [-b]${NC}"
echo -e "      Create worktrees across multiple repositories"
echo -e "      ${DIM}-c, --cursor: Open workspace in Cursor after creation${NC}"
echo -e "      ${DIM}-b, --base-branch: Choose custom base branch for each repo${NC}"
echo ""
echo -e "  ${YELLOW}wt-multi-add${NC} ${DIM}[-c]${NC}"
echo -e "      Add additional repos to existing workspace"
echo -e "      ${DIM}Run from within a worktree directory with .code-workspace file${NC}"
...
echo ""
echo -e "  ${DIM}# Create worktree with custom base branch${NC}"
echo -e "  ${CYAN}wt-new feature/GTT-1234-new-feature -c -b${NC}"
echo ""
...
echo ""
echo -e "  ${DIM}# Create multi-repo with custom base branches${NC}"
echo -e "  ${CYAN}wt-multi-new -c -b${NC}"
echo ""
echo -e "  ${DIM}# Add more repos to existing workspace${NC}"
echo -e "  ${CYAN}cd worktrees/feature-branch && wt-multi-add -c${NC}"
echo ""
...
echo -e "  ${DIM}        ├── AGENTS.md        ${NC}${CYAN}← AI context (wt-agent)${NC}"
...
echo -e "  ${GREEN}✓${NC} Incremental workspace building (add repos anytime)"
